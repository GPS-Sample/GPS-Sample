...
import edu.gtri.gpssample.databinding.ActivityAddConfigurationBinding

class AddConfigurationActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAddConfigurationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAddConfigurationBinding.inflate(layoutInflater)

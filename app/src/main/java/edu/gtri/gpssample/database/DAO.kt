    ...
    fun migrateFrom324To325(db: SQLiteDatabase)
    {
        db.transaction {
            try
            {
                ...
                // Config
                db.execSQL("ALTER TABLE $TABLE_CONFIG ADD COLUMN $COLUMN_CONFIG_IS_ARCHIVED INTEGER")
                ...
                db.execSQL("ALTER TABLE $TABLE_CONFIG ADD COLUMN $COLUMN_CONFIG_ALLOW_SUPERVISOR_EDITS INTEGER")

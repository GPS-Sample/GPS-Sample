...
class PerformMultiCollectionAdapter(var location: Location, var enumerationItems: List<EnumerationItem>) : RecyclerView.Adapter<PerformMultiCollectionAdapter.ViewHolder>()
{
